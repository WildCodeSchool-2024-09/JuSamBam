...
const ConditionsPage = () => {
  return (
    <div className="conditions-page">
      <h1>Conditions générales d'utilisation du site Wildy Gamy</h1>

      <h2>ARTICLE 1 : Objet</h2>
      <p>
        Les présentes « conditions générales d'utilisation » ont pour objet
        l'encadrement juridique de l’utilisation du site Wildy Gamy et de ses
        services.
      </p>
      <p>
        Ce contrat est conclu entre :<p />
      ...
      <p>
        ...
        Le site Wildy Gamy est édité par la société [nom de la société], [statut
        juridique (SAS, SARL, etc.)] au capital de [montant en euros] €, dont le
        siège social est situé au [adresse du siège social].
        <p />
        La société est représentée par [nom et prénom du responsable].
      </p>
      <p>
        Pour les personnes physiques :<p />
        Le site Wildy Gamy est édité par [nom et prénom du responsable],
        domicilié au [adresse postale].
      </p>

      <h2>ARTICLE 3 : accès aux services</h2>
      <p>L’Utilisateur du site Wildy Gamy a accès aux services suivants :</p>
      <ul>
        <li>[Service n°1]</li>
        <li>[Service n°2]</li>
        <li>[Service n°3]</li>
      ...
      <p>
        Les services suivants ne sont pas accessibles pour l’Utilisateur que
        s’il est membre du site (c’est-à-dire qu’il est identifié à l’aide de
      ...
      <p>
        De même, la responsabilité du site ne peut être engagée en cas de force
        majeure ou du fait imprévisible et insurmontable d'un tiers.
      </p>
      <p>
        Le site [votre site] s'engage à mettre en œuvre tous les moyens
      ...
      <p>
        ...
        vidéos, etc.) sont protégés par le droit d’auteur, en vertu du Code de
      ...
      <p>
        ...
        pour procéder à son inscription sur le site.
      </p>
      <p>
        L’adresse électronique (e-mail) de l’utilisateur pourra notamment être
        utilisée par le site [nom de votre site] pour la communication
        d’informations diverses et la gestion du compte.
      </p>
      <p>
        [Votre site] garantit le respect de la vie privée de l’utilisateur,
      ...
      <p>
        ...
        site n’engagent pas la responsabilité de l’Éditeur de [votre site], qui
        n’a pas de contrôle sur ces liens.
      </p>
      <p>
        Il est possible pour un tiers de créer un lien vers une page du site
        [votre site] sans autorisation expresse de l’éditeur.
      </p>

      <h2>ARTICLE 9 : Évolution des conditions générales d’utilisation</h2>
      <p>
        Le site [votre site] se réserve le droit de modifier les clauses de ces
